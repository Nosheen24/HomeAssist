export default function StarRating({ rating = 0, max = 5, size = 'md', showNumber = false, interactive = false, onChange }) {
  const sizes = { sm: 'h-3.5 w-3.5', md: 'h-4 w-4', lg: 'h-5 w-5', xl: 'h-6 w-6' };
