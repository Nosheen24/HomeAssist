    ...
    <div className="min-h-[calc(100vh-8rem)] flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-gray-900">Sign in to HomeAssist</h1>
          <p className="text-gray-500 mt-1 text-sm">Welcome back — enter your details below</p>
        </div>
            ...
            <div className="grid grid-cols-3 gap-2">
              {[
                ...
                <button
                  ...
                  className="px-2 py-1.5 bg-gray-50 hover:bg-indigo-50 border border-gray-200 hover:border-indigo-300 rounded-lg text-xs text-gray-600 hover:text-indigo-700 transition-colors"
                >
                  {d.label}
                </button>
              ))}
